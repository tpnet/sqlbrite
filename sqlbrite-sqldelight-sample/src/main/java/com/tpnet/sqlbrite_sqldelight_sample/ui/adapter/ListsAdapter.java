 ...
 */
package com.tpnet.sqlbrite_sqldelight_sample.ui.adapter;
...
public final class ListsAdapter extends BaseAdapter implements Action1<List<ListsItem>> {
    ...
    //在ListsFragment里面查询数据库完毕，在这里更新适配器
    @Override
